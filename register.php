...
<div class="span6">
		...
		<h3 align="center">Right Time   Examination | cPanel</h3>
		<hr />
			<div class="caption">
			...
			if(isset($_POST['save'])){
				...
				$saveqry = mysqli_query($mysqli, "INSERT INTO codes (id,name,passcode,validity,qset) VALUES ('','$examinee','$passcode','1','$set')");
				if($saveqry){
			...
			<ul style="list-style:none;">
				<li>
					Name of Examinee :<br />
					<input name="examinee" class="span5" type="text" required></input>
				</li>
				<li>
					Reference No. :<br />
					<input name="code" class="span5" type="text" value="<?php echo substr(md5(date('his')), 0, 10); ?>" readonly></input>
				</li>
				<li>
					Set of Questions :<br />
