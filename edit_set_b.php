...
<div class="container">
<br />
<h5>Current Affairs - Questions 1-10 <a href="dashboard.php">BACK to HOME</a></h5>
<?php
			if(isset($_POST['savequest'])){
				...
				$replace = mysqli_query("UPDATE questions SET question='$question', a='$a', b='$b', c='$c', d='$d', answerki='$answer' WHERE numassign='$hi' AND qset='B'");
				$key_replace = mysqli_query("UPDATE answer_key SET a$hi='$answer' WHERE qset='B'");
				}
...
<div class="row">
<?php 
$questions = mysqli_query($mysqli, "SELECT * FROM questions WHERE qset='B'");
...
?>
	<div class="span6">
		<div class="thumbnail well">
			<div class="caption">
			  <p><b>
		      <input value="<?php echo $fetch[1]; ?>" name="question<?php echo $fetch[6];?>" class="span5" type="text"  required="required">
		      </input>
			</b><br />
