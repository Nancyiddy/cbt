...
<div class="container">
<br />
<h5>General Paper - Questions 1-10 <a href="dashboard.php">BACK to HOME</a></h5>
<?php
			if(isset($_POST['savequest'])){
				...
				$replace = mysqli_query($mysqli, "UPDATE questions SET question='$question', a='$a', b='$b', c='$c', d='$d', answerki='$answer' WHERE numassign='$hi' AND qset='C'");
				$key_replace = mysqli_query($mysqli, "UPDATE answer_key SET a$hi='$answer' WHERE qset='C'");
				}
...
<div class="row">
<?php 
$questions = mysqli_query($mysqli, "SELECT * FROM questions WHERE qset='C'");
