			...
			$source = mysqli_query($mysqli, "SELECT * FROM codes WHERE passcode = '$mycode'");
			...
			$compare = mysqli_query($mysqli, "SELECT * FROM users WHERE username='$username' AND password='$password'");
